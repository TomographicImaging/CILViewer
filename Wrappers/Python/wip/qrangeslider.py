...
class QRangeSlider(QtWidgets.QWidget, Ui_Form):
    ...
    headPressed = QtCore.pyqtSignal(int)
    headReleased = QtCore.pyqtSignal(int)
    tailPressed = QtCore.pyqtSignal(int)
    tailReleased = QtCore.pyqtSignal(int)
