...
from ccpi.viewer.ui.dialogs import (
    HDF5InputDialog,
    RawInputDialog,
    ViewerSettingsDialog,
    SaveableRawInputDialog,
)
...
from eqt.ui.MainWindowWithSessionManagement import (
...
class ViewerMainWindowWithSessionManagement(MainWindowWithSessionManagement, ViewerMainWindow):
    ...
    def __init__(
        ...
        super(ViewerMainWindowWithSessionManagement, self).__init__(
            title,
            app_name,
            settings_name=settings_name,
            organisation_name=organisation_name,
