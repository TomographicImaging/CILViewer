...
TOOLTIPS_VOLUME_RENDER_SETTINGS = {
    "volume_visibility": "Toggle the visibility of the 3D volume render",
    "windowing_slider_min": "Adjust the minimum intensity value in the window range",
    "windowing_slider_max": "Adjust the maximum intensity value in the window range",
    "opacity_mapping": "Select the opacity mapping technique to apply to the render",
    "colour_scheme": "Select the colour scheme to apply to the render",
    "volume_clipping": "Toggle volume clipping",
