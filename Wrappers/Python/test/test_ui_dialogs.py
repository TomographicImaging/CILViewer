...
class TestViewerSettingsDialog(unittest.TestCase):
    ...
    def test_init_calls_init_app_settings_and_addViewerSettingsWidgets(self,  mock_addViewerSettingsWidgets, mock_app_settings_init):
        parent = QMainWindow()
...
class TestViewerSessionSettingsDialog(unittest.TestCase):
    ...
    def test_init_calls_init_ViewerSettingsDialog_and_addViewerSessionSettingsWidgets(self):
        ...
        with mock.patch.object(ViewerSettingsDialog, '__init__') as mock_ViewerSettingsDialog_init:
            with mock.patch.object(ViewerSessionSettingsDialog, '_addViewerSessionSettingsWidgets') as mock_addViewerSessionSettingsWidgets:
...
class TestRawInputDialog(unittest.TestCase):
    ...
    def test_getRawAttrs(self):
        ...
        assert rdi.getRawAttrs() == {'shape': [1, 2, 3], 'typecode': 'uint16', 'is_big_endian': True, 'is_fortran': False}
