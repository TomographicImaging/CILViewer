...
class TestImageReaderWriter(unittest.TestCase):
    ...
    def test_read_resample(self):
        ...
        target_size=100
        readerhdf5 = ImageReader(file_name=self.hdf5_filename_3D, target_size=target_size, is_acquisition_data=False, hdf5_dataset_name="ImageData")
        self._test_resampling_not_acq_data(readerhdf5, target_size)
        readernpy = ImageReader(file_name=self.numpy_filename_3D, target_size=target_size, is_acquisition_data=False)
        self._test_resampling_not_acq_data(readernpy, target_size)
        readermhd = ImageReader(file_name=self.mha_filename_3D, target_size=target_size, is_acquisition_data=False)
        self._test_resampling_not_acq_data(readermhd, target_size)
        readerraw = ImageReader(file_name=self.raw_filename_3D, target_size=target_size, is_acquisition_data=False, raw_image_attrs=self.raw_image_attrs)
        ...
        readerhdf5 = ImageReader(file_name=self.hdf5_filename_3D, target_size=target_size, is_acquisition_data=True, hdf5_dataset_name="ImageData")
        self._test_resampling_acq_data(readerhdf5, target_size)
        readernpy = ImageReader(file_name=self.numpy_filename_3D, target_size=target_size, is_acquisition_data=True)
        self._test_resampling_acq_data(readernpy, target_size)
        readermhd = ImageReader(file_name=self.mha_filename_3D, target_size=target_size, is_acquisition_data=True)
        self._test_resampling_acq_data(readermhd, target_size)
        readerraw = ImageReader(file_name=self.raw_filename_3D, target_size=target_size, is_acquisition_data=True, raw_image_attrs=self.raw_image_attrs)
    ...
    def test_read_cropped(self):
        ...
        # HDF5: ------------------------------------------------------------------------------------------
        reader = ImageReader(file_name=self.hdf5_filename_3D, crop=True, resample=False, target_z_extent=[1, 1], is_acquisition_data=False,  hdf5_dataset_name = "ImageData")
