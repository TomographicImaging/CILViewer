...
line_widget = cilviewerLineWidget.AtCoordOnXYPlane(window.frame.viewer, 'x', 5)
line_widget.On()
box_widget = cilviewerBoxWidget.AroundSliceOnXYPlane(window.frame.viewer, 'y', 10, width=1, outline_color=(0, 0, 1))
box_widget.On()
